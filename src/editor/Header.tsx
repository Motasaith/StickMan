...
import { ArrowLeft, Check, CloudOff, Download, History, Loader2, Redo2, Undo2 } from "lucide-react";
...
export function Header({ onExport, onVersions }: { onExport: () => void; onVersions: () => void }) {
